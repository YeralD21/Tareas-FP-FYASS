...
func main() {
  var numero int64 //int numero - en java
  fmt.Println("Ingrese un numero:") //sysout - en java
  fmt.Scanln(&numero) //import scanner - leer teclado _ lt - en java-8 numero=8
