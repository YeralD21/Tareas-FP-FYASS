...
String claveV, hayMas="S";
        ...
        while (hayMas.equals("S")) {
            ...
            if (claveV.equals("VC1")) {
                System.out.println("Ingrese cantidad de Vehiculo con clave "+claveV+":");
        ...
        System.out.println("-------------------------------------------------------------------");
        System.out.println("El total a pagar por todos los vehiculos es:" +(precioVC1+precioVC2+precioVC3+totalImpV));

    }

    public static void main(String[] args) {
        new Pregunta2().pregunta02();
    }
